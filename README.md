...
[https://github.com/hadrienmichel/SardineReborn/archive/refs/tags/v0.1.2.zip](https://github.com/hadrienmichel/SardineReborn/archive/refs/tags/v0.1.2.zip). Un-zip the downloaded archive and locate the directory where it is placed (C:/my-directory) 
